...
<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        ...
        <ul class="flex space-x-6 mr-6 text-lg">
            @auth
                ...
                <li>
                    <a href="/listings/user/manage" class="hover:text-laravel"><i class="fa-solid fa-gear"></i> Manage
                        Listings</a>
                </li>
    ...
    <footer
        ...
        <a href="/listings/create" class="absolute top-1/3 right-10 bg-black rounded-lg text-white py-2 px-5">Post Job</a>
    </footer>
